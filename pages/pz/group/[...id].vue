<script setup lang="ts">
	...
	import groupConfig from '@/assets/data/configs/group/group.json';
	import jsonConfig from '@/assets/data/configs/group/group_json.json';
	import { CLONE } from '@/utils/modify-object.function';

	definePageMeta({
		title: 'route.group_detail',
		visible: false,
		icon: {
			value: 'mdi-cog',
		},
	...
	const config = CLONE(groupConfig);
